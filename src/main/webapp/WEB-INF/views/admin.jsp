...
<body bgcolor="skyblue">
	...
	<a style="text-decoration: blink; font-style: italic; font: bold;"
		href="admin/addProductForm"> Add
		Product</a>
	...
	<table style="border-style: dotted;" bgcolor="#a8a8a8" align="center"
		...
		<c:forEach items="${productList}" var="product">
			<tr>
				<td><c:out value="${product.category.category_id}"></c:out></td>
				<td><c:out value="${product.category.category_name}"></c:out></td>
